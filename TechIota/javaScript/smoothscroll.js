/**
 * SmoothScroll Dual-licensed under the GPL and MIT licenses. All individual
 * scripts remain property of their copyrighters. Version: 1.0.1
 */
if (!window['jQuery'])
	alert('The jQuery library must be included before the smoothscroll.js file.  The plugin will not work propery.');

/**
 * jQuery.ScrollTo - Easy element scrolling using jQuery. Dual licensed under
 * MIT and GPL.
 * 
 * @version 1.4.3.1
 */
